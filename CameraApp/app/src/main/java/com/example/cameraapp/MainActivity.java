...
public class MainActivity extends AppCompatActivity {
    ...
    public String landScapePath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/";
    public String portraitPath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/Portrait";
    public String selfiesPath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/Selfies";
